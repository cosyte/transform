 ...
 * `v2-0128`, `v2-0335`, `v2-0528`), the FHIR R4 core code systems (`allergy-intolerance-category`,
 * `allergy-intolerance-type`, `allergy-intolerance-criticality`) and HL7 v3
 * (`v3-RouteOfAdministration`, `v3-TimingEvent`) are HL7's own, license-clean. The IG's `*-to-sct`
 * value maps,
