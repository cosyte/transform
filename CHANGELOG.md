...
- 22e4351: **This is 0.1.0, the first release of `@cosyte/transform` whose public API we treat as settled.**
...
- 990be26: No runtime impact: the repository's own PHI scanner now checks every HL7 v2 field number it reads against a published HL7 v2.5.1, and reads seven PHI-bearing fields it previously disclosed as unread.
